...
CUDA_VISIBLE_DEVICES=4,5 python train.py --config ./config/universal_wholemodel.yaml --sks_name "mam" &
CUDA_VISIBLE_DEVICES=6,7 python train.py --config ./config/universal_wholemodel.yaml --sks_name "bo" 
wait