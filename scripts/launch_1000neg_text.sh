...
CUDA_VISIBLE_DEVICES=4,5 python train.py --config ./config/1000neg-text.yaml --sks_name "ciin" &
CUDA_VISIBLE_DEVICES=6,7 python train.py --config ./config/1000neg-text.yaml --sks_name "khanhvy" 
wait
...
CUDA_VISIBLE_DEVICES=2,3 python train.py --config ./config/1000neg-text.yaml --sks_name "mam"
